import { JoystickManagerOptions, JoystickManager, EventData, JoystickOutputData, create as createManager } from 'nipplejs';
import { Direction } from '../utils/Types';

type JoystickState = {evt: EventData | null, data: JoystickOutputData | null, dir: string, plain: string};
